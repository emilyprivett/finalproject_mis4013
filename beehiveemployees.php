...
<html lang="en">
  ...
  <body style="background-color: #F8EDDB">
    ...
    <h1 style="text-align:center; font-family:Rockwell; font-weight:bold;">The Beehive's Employees</h1>
...
$sql = "SELECT EmployeeID, Employee_FirstName, Employee_LastName, Employee_Age, Years_Of_Experience FROM Employee WHERE BarID=1";
