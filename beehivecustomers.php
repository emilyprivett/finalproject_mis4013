...
$sql = "SELECT CustomerID, Customer_FirstName,Customer_LastName, Customer_Age FROM Drink d JOIN Order o ON d.DrinkID=o.DrinkID JOIN Customer c ON o.OrderID=c.OrderID WHERE d.BarID=1";
