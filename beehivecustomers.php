...
$sql = "SELECT CustomerID, Customer_FirstName,Customer_LastName, Customer_Age FROM Customer c JOIN Order o ON c.CustomerID=o.CustomerID JOIN Drink d ON o.DrinkID=d.DrinkID WHERE d.BarID=1";
