...
?>
    ...
    <a href="beehivecustomers.php" class="btn btn-secondary btn-lg btn-block"> The BeeHive's Customers<a/>
    <a href="beehiveemployees.php" class="btn btn-secondary btn-lg btn-block"> The BeeHive's Employees<a/>
