...
<html lang="en">
  ...
  <body style="background-color: #F8EDDB">
    ...
    <h1 style="text-align:center; font-family:Rockwell; font-weight:bold;">The Tipsy Tiki</h1>
...
$sql = "SELECT DrinkID, Drink_Name, Drink_Recipe, Drink_Cost FROM Drink WHERE BarID=3";
...
?>
    ...
    <a href="tikiemployees.php" class="btn btn-secondary btn-lg btn-block" style="font-family:Rockwell;"> The Tipsy Tiki's Employees<a/>
